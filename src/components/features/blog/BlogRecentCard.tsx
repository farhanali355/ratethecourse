...
export function BlogRecentCard({ post }: { post: BlogPost }) {
    return (
        <div className="bg-[#0088EE] rounded-[24px] overflow-hidden group flex flex-col h-full [box-shadow:0_15px_35px_rgba(0,0,0,0.25)] transition-all hover:scale-[1.02]">
            {/* Image Container */}
